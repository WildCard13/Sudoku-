...
def preProcess(img):
    ...
    imgThreshold = cv2.adaptiveThreshold(imgBlur, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, 1, 11, 2)  # APPLY ADAPTIVE THRESHOLD
    return imgThreshold
...
#  ### 4 and 5 -  TO DISPLAY THE SOLUTION ON THE IMAGE

def displayNumbers(img, numbers, color=(70, 130, 180)):
